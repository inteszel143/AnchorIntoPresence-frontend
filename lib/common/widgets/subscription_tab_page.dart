...
class SubscriptionTabPage extends StatelessWidget {
  ...
  static const _content = [
    (
      title: 'Home',
      accent: Color(0xFF655847),
      lightAccent: Color(0xFFD8C8B2),
      tint: Color(0xFFE8E3D8),
    ...
    (
      title: 'Meditate',
      accent: Color(0xFF62528B),
      lightAccent: Color(0xFFCBBBEF),
      tint: Color(0xFFEDE8F6),
    ...
    (
      title: 'Community',
      accent: Color(0xFF975239),
      lightAccent: Color(0xFFF0B69E),
      tint: Color(0xFFF8EAE2),
    ...
    (
      title: 'Track',
      accent: Color(0xFF376780),
      lightAccent: Color(0xFFA5CEE5),
      tint: Color(0xFFE4EEF5),
